...
namespace KevGitChanges
{
    ...
    internal sealed class ToolWindow1Command
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("e90cea7b-274d-4878-8865-203da963f97c");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(KevGitChangesToolWindow), 0, true);
